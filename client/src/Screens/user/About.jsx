  ...
  return (
    <div id="about" className='mb-[100px]'>
      <div className='w-full h-[600px] flex items-center'>
        <div className='w-1/2 h-full flex justify-center items-center bg-[rgb(245,245,245)]'>
            <h1 className='font-bold text-[50px]'>About Us</h1> 
        </div>
        <div className='w-1/2 h-[80%] bg-white rounded-2xl shadow-2xl mr-20 px-10 py-10'>
            <div className='w-full '>
                <h2 className='w-full font-bold text-xl align-center mb-5'>The Great Place Of Medical Hosptial Center</h2>
                ...
                <div className='w-full flex flex-col mt-8'>
                    <div className='w-full flex'>
                        <div className='w-1/2 bg-[rgb(245,245,245)] rounded h-[50px] flex items-center px-4 font-bold mr-3'>
