...
export const CreateReport = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://localhost:5000/reports/create",
      data
    );
    console.log(res);
    return res.data;
...
export const AddPatients = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://localhost:5000/patients/register",
      data
    );
    return res.data;
    // dispatch({
...
export const CreatePayment = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://localhost:5000/payments/add",
      data
    );
...
export const GetBeds = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get("https://localhost:5000/beds");
    console.log(res);
    dispatch({
...
export const CreateBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `https://localhost:5000/appointments/create`,
      data
    );
    console.log(res);
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://localhost:5000/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `https://localhost:5000/beds/discharge`,
      data
    );
    console.log(res);
    // return res.data;
...
export const GetAllData = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://localhost:5000/hospitals`
    );
    console.log(res.data);
    dispatch({
...
export const GetAllAppointment = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://localhost:5000/appointments`
    );
    // console.log(res.data);
    // return res.data;
    dispatch({
...
export const DeleteAppointment = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.delete(
      `https://localhost:5000/appointments/${id}`
    );
    console.log(res.data);
    // return res.data;
    dispatch({
